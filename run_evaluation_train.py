...
if __name__ == "__main__":
    ...
    results_dir = REPO_ROOT + f"/results_with_sparsity_TRAIN/seed_{SEED}/"
    ...
    cnn_unstd_evaluation_per_shot(train_dataloader, config_task, cnn_model, base_model_dir, accumulator)
